!(function () {
  ...
  e &&
    e.addEventListener("click", function (s) {
      ...
      t &&
        (t.classList.contains("fa-times")
          ? (t.classList.remove("fa-times"), t.classList.add("fa-bars"))
          : t.classList.contains("fa-bars") &&
            (t.classList.remove("fa-bars"), t.classList.add("fa-times")));
    });
  ...
  if (s) {
    ...
    for (var r of t)
      r.addEventListener("click", function (s) {
        a.classList.remove("active"), e.classList.remove("active");
        var t = e.querySelector(".fa-bars, .fa-times");
        t &&
          (t.classList.contains("fa-times")
            ? (t.classList.remove("fa-times"), t.classList.add("fa-bars"))
